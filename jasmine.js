...
/**
 * This file is a library for the tern autocomplete
 */
...
(function(mod) {
  ...
  function postLoadDef(data) {
    ...
    let cx = infer.cx(), interfaces = cx.definitions[data['!name']]['!jasmine'];
    if (interfaces) {
      // it's a custom matchers, fill !jasmine object with custom property matchers.
      const to = cx.definitions['jasmine']['!jasmine'];
      const from = interfaces;
